...
export default function Skills() {
  ...
  return (
    <div className="relative mt-10 overflow-hidden rounded-lg border border-brand-borderLight bg-black/[0.02] p-6 dark:border-brand-border dark:bg-white/[0.02]">
      <div className="text-brand-mutedLight dark:text-brand-muted">
        <NeuralBackground />
      </div>
